...
var resizeCanvas=require("../utils/resizeCanvas"),signals=require("../core/signals"),CLASS_IS_VISIBLE="is-visible",COUNTER=0;exports.selector=".js-card",exports.constructor=function(){function e(e){l=e,f=e.getElementsByClassName("js-card__size")[0],h=e.getElementsByClassName("js-card__canvas")[0],B=e.getElementsByClassName("js-card__image")[0],A=e.getElementsByClassName("js-card__cover")[0],L=h.getContext("2d"),C={p:0},E=0,m=h.getAttribute("data-mp4"),_=B.getAttribute("data-src"),b=A.getAttribute("data-src"),S=window.innerHeight,signals.SCROLLED.add(t),signals.RESIZED.add(d),d(),t()}function t(){var e=window.scrollY,t=l.getBoundingClientRect().top+e;S+e>t&&t+p>e&&a()}function n(){g=!1,v=null,TweenLite.killTweensOf(C),l.removeEventListener("mouseenter",s),l.removeEventListener("mouseleave",i),signals.SCROLLED.remove(t)}function s(){v||o(),g=!0,c(),v.play(),TweenLite.to(C,.5,{p:1,ease:Cubic.easeInOut})}function i(){TweenLite.to(C,.5,{p:0,ease:Cubic.easeInOut,onComplete:function(){v.pause(),v.currentTime=0,g=!1}})}function a(){l.classList.add(CLASS_IS_VISIBLE),r(),c(),l.addEventListener("mouseenter",s),l.addEventListener("mouseleave",i),signals.SCROLLED.remove(t)}function r(){function e(){B.classList.add(CLASS_IS_VISIBLE)}B.onload=e,B.src=_}function o(){v=document.createElement("video"),v.loop=!0,v.src=m,A.src=b}function c(){L.clearRect(0,0,w,I),C.p>0&&u(C.p),g&&requestAnimationFrame(c)}function u(e){function t(e,t){L.lineTo(e,t)}var n=Math.min(1,2*e),s=Math.max(0,2*(e-.5));L.save(),L.beginPath(),L.moveTo(0,I),t(Math.round(w*n),I),s&&(t(w,Math.round(I*(1-s))),t(Math.round(w*s),0)),t(0,Math.round(I*(1-n))),L.closePath(),L.clip(),L.drawImage(A,0,0,w,I),L.drawImage(v,0,0,w,I),L.restore()}function d(){S=window.innerHeight,w=f.offsetWidth,I=f.offsetHeight,B.setAttribute("width",w),B.setAttribute("height",I),A.setAttribute("width",w),A.setAttribute("height",I),p=l.offsetHeight,resizeCanvas(h,w,I),g||c()}var l,m,g,v,f,h,L,C,E,S,p,w,I,_,b,A,B;this.init=e,this.destroy=n};
},{"../core/signals":3,"../utils/resizeCanvas":10}],8:[function(require,module,exports){
...
},{"../core/signals":3}],9:[function(require,module,exports){
