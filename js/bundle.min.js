...
var resizeCanvas=require("../utils/resizeCanvas"),signals=require("../core/signals"),CLASS_IS_VISIBLE="is-visible",COUNTER=0;exports.selector=".js-card",exports.constructor=function(){function e(e){l=e,v=e.getElementsByClassName("js-card__size")[0],h=e.getElementsByClassName("js-card__canvas")[0],T=e.getElementsByClassName("js-card__image")[0],A=e.getElementsByClassName("js-card__cover")[0],L=h.getContext("2d"),C={p:0},E=0,m=h.getAttribute("data-mp4"),_=T.getAttribute("data-src"),b=A.getAttribute("data-src"),p=window.innerHeight,signals.SCROLLED.add(t),signals.RESIZED.add(d),d(),t()}function t(){var e=window.pageYOffset||document.scrollTop,t=l.getBoundingClientRect().top+e;p+e>t&&t+S>e&&a()}function n(){g=!1,f=null,TweenLite.killTweensOf(C),l.removeEventListener("mouseenter",s),l.removeEventListener("mouseleave",i),signals.SCROLLED.remove(t)}function s(){f||r(),g=!0,c(),f.play(),TweenLite.to(C,.5,{p:1,ease:Cubic.easeInOut})}function i(){TweenLite.to(C,.5,{p:0,ease:Cubic.easeInOut,onComplete:function(){f.pause(),f.currentTime=0,g=!1}})}function a(){l.classList.add(CLASS_IS_VISIBLE),o(),c(),l.addEventListener("mouseenter",s),l.addEventListener("mouseleave",i),signals.SCROLLED.remove(t)}function o(){function e(){T.classList.add(CLASS_IS_VISIBLE)}T.onload=e,T.src=_}function r(){f=document.createElement("video"),f.loop=!0,f.src=m,A.src=b}function c(){L.clearRect(0,0,w,I),C.p>0&&u(C.p),g&&requestAnimationFrame(c)}function u(e){function t(e,t){L.lineTo(e,t)}var n=Math.min(1,2*e),s=Math.max(0,2*(e-.5));L.save(),L.beginPath(),L.moveTo(0,I),t(Math.round(w*n),I),s&&(t(w,Math.round(I*(1-s))),t(Math.round(w*s),0)),t(0,Math.round(I*(1-n))),L.closePath(),L.clip(),L.drawImage(A,0,0,w,I),L.drawImage(f,0,0,w,I),L.restore()}function d(){p=window.innerHeight,w=v.offsetWidth,I=v.offsetHeight,T.setAttribute("width",w),T.setAttribute("height",I),A.setAttribute("width",w),A.setAttribute("height",I),S=l.offsetHeight,resizeCanvas(h,w,I),g||c()}var l,m,g,f,v,h,L,C,E,p,S,w,I,_,b,A,T;this.init=e,this.destroy=n};
