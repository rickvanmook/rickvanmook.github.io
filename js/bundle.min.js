...
var history=require("../core/history");exports.selector="a",exports.constructor=function(){function t(t){u=t,c=t.getAttribute("href"),i(t)||o(c)||n(c)||u.addEventListener("click",e)}function e(t){t.metaKey||t.ctrlKey||(t.preventDefault(),c!==window.location.pathname&&history.pushState(c))}function r(){u.removeEventListener("click",e),c=null,u=null}function n(t){return 0===t.indexOf("mailto:")}function i(t){var e=t.getAttribute("target");return"_blank"===e}function o(t){var e=/^(\w+:)?\/\//;return void 0!==t&&-1!==t.search(e)}var c,u;this.init=t,this.destroy=r};
