...
var resizeCanvas=require("../utils/resizeCanvas"),signals=require("../core/signals"),CLASS_IS_VISIBLE="is-visible",COUNTER=0;exports.selector=".js-card",exports.constructor=function(){function e(e){v=e,E=e.getElementsByClassName("js-card__size")[0],h=e.getElementsByClassName("js-card__canvas")[0],O=e.getElementsByClassName("js-card__image")[0],B=e.getElementsByClassName("js-card__cover")[0],C=h.getContext("2d"),p={p:0},S=0,L=h.getAttribute("data-mp4"),A=O.getAttribute("data-src"),T=B.getAttribute("data-src"),w=window.innerHeight,signals.SCROLLED.add(t),signals.RESIZED.add(m),m(),t()}function t(){var e=window.pageYOffset||document.scrollTop||0,t=v.getBoundingClientRect().top+e;w+e>t&&t+I>e&&a()}function n(){g=!1,f=null,TweenLite.killTweensOf(p),v.removeEventListener("mouseenter",s),v.removeEventListener("mouseleave",i),v.removeEventListener("mouseenter",s),v.removeEventListener("mouseleave",i),signals.SCROLLED.remove(t)}function s(){f||c(),g=!0,d(),f.play(),TweenLite.to(p,.5,{p:1,ease:Cubic.easeInOut})}function i(){TweenLite.to(p,.5,{p:0,ease:Cubic.easeInOut,onComplete:function(){f.pause(),f.currentTime=0,g=!1}})}function a(){v.classList.add(CLASS_IS_VISIBLE),u(),d(),v.addEventListener("touchstart",r),v.addEventListener("touchend",o),v.addEventListener("mouseenter",s),v.addEventListener("mouseleave",i),signals.SCROLLED.remove(t)}function r(){v.removeEventListener("mouseenter",s),v.removeEventListener("mouseleave",i)}function o(){v.addEventListener("mouseenter",s),v.addEventListener("mouseleave",i)}function u(){function e(){O.classList.add(CLASS_IS_VISIBLE)}O.onload=e,O.src=A}function c(){f=document.createElement("video"),f.loop=!0,f.src=L,B.src=T}function d(){C.clearRect(0,0,_,b),p.p>0&&l(p.p),g&&requestAnimationFrame(d)}function l(e){function t(e,t){C.lineTo(e,t)}var n=Math.min(1,2*e),s=Math.max(0,2*(e-.5));C.save(),C.beginPath(),C.moveTo(0,b),t(Math.round(_*n),b),s&&(t(_,Math.round(b*(1-s))),t(Math.round(_*s),0)),t(0,Math.round(b*(1-n))),C.closePath(),C.clip(),C.drawImage(B,0,0,_,b),C.drawImage(f,0,0,_,b),C.restore()}function m(){w=window.innerHeight,_=E.offsetWidth,b=E.offsetHeight,O.setAttribute("width",_),O.setAttribute("height",b),B.setAttribute("width",_),B.setAttribute("height",b),I=v.offsetHeight,resizeCanvas(h,_,b),g||d()}var v,L,g,f,E,h,C,p,S,w,I,_,b,A,T,B,O;this.init=e,this.destroy=n};
